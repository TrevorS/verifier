...
def format_example(input_text: str, target: str) -> str:
...
def format_examples(examples: list[dict[str, str]]) -> str:
    ...
    for example in examples:
        formatted.append(format_example(example["input"], example["target"]))
    return "\n\n".join(formatted)
...
def create_prompt(
    ...
    args:
        ...
        examples: optional list of example dictionaries with 'input' and 'target' keys
